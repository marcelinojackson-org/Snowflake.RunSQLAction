...
const shared_ini_file_loader_1 = __webpack_require__(6804);
const fs_1 = __webpack_require__(79896);
const fromWebToken_1 = __webpack_require__(51829);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(688)));
...
var fromTokenFile = __webpack_require__(17007);
var fromWebToken = __webpack_require__(51829);
