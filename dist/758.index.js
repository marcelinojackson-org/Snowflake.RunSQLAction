...
const core_1 = __webpack_require__(3520);
const util_middleware_1 = __webpack_require__(53956);
...
const util_endpoints_1 = __webpack_require__(36700);
const util_endpoints_2 = __webpack_require__(33082);
const ruleset_1 = __webpack_require__(46607);
...
var middlewareHostHeader = __webpack_require__(86606);
var middlewareLogger = __webpack_require__(56442);
var middlewareRecursionDetection = __webpack_require__(59552);
var middlewareUserAgent = __webpack_require__(85727);
var configResolver = __webpack_require__(86964);
var core = __webpack_require__(54242);
var middlewareContentLength = __webpack_require__(41484);
var middlewareEndpoint = __webpack_require__(60675);
var middlewareRetry = __webpack_require__(63746);
var smithyClient = __webpack_require__(21571);
var httpAuthSchemeProvider = __webpack_require__(98521);
var runtimeConfig = __webpack_require__(6728);
var regionConfigResolver = __webpack_require__(85071);
var protocolHttp = __webpack_require__(47012);
var middlewareSerde = __webpack_require__(60439);
var core$1 = __webpack_require__(3520);
...
const tslib_1 = __webpack_require__(4996);
const package_json_1 = tslib_1.__importDefault(__webpack_require__(70292));
const core_1 = __webpack_require__(3520);
const util_user_agent_node_1 = __webpack_require__(68648);
const config_resolver_1 = __webpack_require__(86964);
const hash_node_1 = __webpack_require__(78820);
const middleware_retry_1 = __webpack_require__(63746);
const node_config_provider_1 = __webpack_require__(20600);
const node_http_handler_1 = __webpack_require__(255);
const util_body_length_node_1 = __webpack_require__(50886);
const util_retry_1 = __webpack_require__(43902);
const runtimeConfig_shared_1 = __webpack_require__(53449);
const smithy_client_1 = __webpack_require__(21571);
const util_defaults_mode_node_1 = __webpack_require__(41643);
const smithy_client_2 = __webpack_require__(21571);
...
exports.getRuntimeConfig = void 0;
const core_1 = __webpack_require__(3520);
const core_2 = __webpack_require__(54242);
const smithy_client_1 = __webpack_require__(21571);
const url_parser_1 = __webpack_require__(14526);
const util_base64_1 = __webpack_require__(83841);
const util_utf8_1 = __webpack_require__(34209);
const httpAuthSchemeProvider_1 = __webpack_require__(98521);
const endpointResolver_1 = __webpack_require__(25583);
const getRuntimeConfig = (config) => {
    return {
...
var utilBufferFrom = __webpack_require__(4119);
...
var protocolHttp = __webpack_require__(47012);
var core = __webpack_require__(54242);
var propertyProvider = __webpack_require__(69862);
var client = __webpack_require__(10752);
var signatureV4 = __webpack_require__(88014);
...
var propertyProvider = __webpack_require__(69862);
var sharedIniFileLoader = __webpack_require__(6804);
var client = __webpack_require__(10752);
var tokenProviders = __webpack_require__(71593);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(50057); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(77478);
...
var client = __webpack_require__(10752);
var httpAuthSchemes = __webpack_require__(92243);
var propertyProvider = __webpack_require__(69862);
var sharedIniFileLoader = __webpack_require__(6804);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 939).then(__webpack_require__.t.bind(__webpack_require__, 79939, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 939).then(__webpack_require__.t.bind(__webpack_require__, 79939, 19));
